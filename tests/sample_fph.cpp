...
void TestFphMap() {
    ...
    using DyFphMap = fph::DynamicFphMap<KeyType, MappedType, SeedHash, std::equal_to<>, Allocator,
                                        BucketParamType , KeyRNG>;
    using FphMetaMap = fph::MetaFphMap<KeyType, MappedType, SeedHash, std::equal_to<>, Allocator,
            BucketParamType>;
