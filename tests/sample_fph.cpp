...
void TestFphMap() {
    ...
    using DyFphMap = fph::DynamicFphMap<KeyType, MappedType, SeedHash, KeyEqual, Allocator,
                                        BucketParamType , KeyRNG>;
    using FphMetaMap = fph::MetaFphMap<KeyType, MappedType, SeedHash, KeyEqual, Allocator,
            BucketParamType>;
